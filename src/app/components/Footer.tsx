        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/returns" className="text-gray-400 hover:text-white transition duration-300">Returns</Link></li>
              <li><Link href="/shipping" className="text-gray-400 hover:text-white transition duration-300">Shipping Info</Link></li>
              <li><Link href="/size-guide" className="text-gray-400 hover:text-white transition duration-300">Size Guide</Link></li>
